...
func (r *Repository) Create(ctx context.Context, issue *entity.Issue) error {
	return infrastructure.GetDB().WithContext(ctx).Create(issue).Error
}

func (r *Repository) Update(ctx context.Context, issue *entity.Issue) error {
	return infrastructure.GetDB().WithContext(ctx).Save(issue).Error
}
...
func (r *Repository) Delete(ctx context.Context, id string) error {
	return infrastructure.GetDB().WithContext(ctx).Delete(&entity.Issue{}, "id = ?", id).Error
}
